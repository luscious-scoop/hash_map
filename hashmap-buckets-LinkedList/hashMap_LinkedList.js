...
// console.log(test.showAllHashMapLinkedLists());
// console.log(test.length());
// console.log(test.getHashMap().length);

console.log('after overwriting');
test.set('lion', 'tiger');
test.set('kite', 'patang');
test.set('grape', 'pr');
...
console.log(test.set('grape', 'fuhj'));
console.log(test.set('hat', 'mao'));
